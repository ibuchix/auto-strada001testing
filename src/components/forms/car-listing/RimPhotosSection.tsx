...
export const RimPhotosSection = () => {
  ...
  // Use our safe form context instead of direct useFormContext
  ...
  // Use SafeFormWrapper to handle the form context safely
  return (
    <SafeFormWrapper>
      {(form) => {
        // This code only runs if form is available
