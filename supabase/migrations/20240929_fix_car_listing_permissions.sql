...
-- Migration to implement security definer function for car listings
-- This function allows authenticated sellers to reliably create car listings

-- Create or update the security definer function for car listings
